...
const SocialSharing: React.FC<SocialSharingProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[75vh] overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 overflow-auto">
          <div className="p-4 sm:p-6">
            ...
            <div className="mb-4">
              <h3 className="text-base font-semibold text-gray-900 mb-3">Share on Social Media</h3>
            ...
            {/* Share Statistics */}
            <div className="mb-4">
              <h3 className="text-base font-semibold text-gray-900 mb-3">Share Statistics</h3>
            ...
            <div className="bg-yellow-50 rounded-lg p-3 border border-yellow-200">
              <h4 className="font-semibold text-yellow-900 mb-1">SEO Optimized Sharing</h4>
