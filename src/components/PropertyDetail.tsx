...
const PropertyDetail: React.FC<PropertyDetailProps> = ({ propertyId, onBackToHome, user, isAuthenticated, onBookingSuccess, onShowSocialSharing }) => {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-cream-50 to-white flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          <div className="w-16 h-16 border-4 border-rust-500 border-t-transparent rounded-full animate-spin mx-auto mb-6"></div>
          <h2 className="text-xl font-medium text-gray-900 mb-2">Loading your perfect stay...</h2>
          <p className="text-gray-600 text-sm mb-4">We're preparing everything for you</p>
          
          {/* Progress Indicators - Psychological UX Enhancement */}
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-center space-x-2 text-xs text-gray-500">
              <div className="w-2 h-2 bg-rust-400 rounded-full animate-pulse" style={{animationDelay: '0.2s'}}></div>
              <span>Preparing photos...</span>
            </div>
            <div className="flex items-center justify-center space-x-2 text-xs text-gray-500">
              <div className="w-2 h-2 bg-rust-300 rounded-full animate-pulse" style={{animationDelay: '0.4s'}}></div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-cream-50 to-white flex items-center justify-center px-4">
        <div className="text-center max-w-sm">
          ...
          <p className="text-gray-600 text-sm mb-6">{error || 'This property is no longer available'}</p>
          <button 
            onClick={onBackToHome}
            className="bg-rust-500 text-white px-6 py-3 rounded-lg hover:bg-rust-600 transition-colors font-medium w-full sm:w-auto"
          >
            Back to Properties
          </button>
        </div>
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Enhanced Floating Action Buttons for Mobile - Better UX */}
      <div className="fixed bottom-4 right-4 z-40 lg:hidden">
        <div className="flex flex-col space-y-3">
          {/* Enhanced Quick Book Button */}
          <button 
            onClick={() => setIsBookingModalOpen(true)}
            className="bg-gradient-to-r from-rust-500 to-rust-600 hover:from-rust-600 hover:to-rust-700 text-white font-semibold py-3 px-6 rounded-full shadow-xl transition-all duration-200 text-sm flex items-center space-x-2 transform hover:scale-105 active:scale-95"
          >
            <Calendar className="w-4 h-4" />
            <span>Book Now</span>
          </button>
          
          {/* Enhanced View Photos Button */}
          <button 
            onClick={() => openLightbox(0)}
            className="bg-white/95 backdrop-blur-md hover:bg-white text-gray-900 font-medium py-3 px-6 rounded-full shadow-xl transition-all duration-200 text-sm flex items-center space-x-2 border border-gray-200 transform hover:scale-105 active:scale-95"
          >
      ...
      {/* Need Help? Floating Support - Psychological UX Enhancement */}
      <div className="fixed bottom-4 left-4 z-40 lg:hidden">
        <button 
          ...
          className="bg-white/90 backdrop-blur-sm hover:bg-white text-gray-900 font-medium py-3 px-4 rounded-full shadow-lg transition-colors text-sm flex items-center space-x-2"
        >
      ...
      {/* Enhanced Hero Section - Research-Driven UX Improvements */}
      <div className="relative h-[60vh] sm:h-[70vh] md:h-[75vh] lg:h-[80vh] overflow-hidden">
        {/* Advanced Gradient Overlay for Optimal Readability */}
        ...
        {/* Main Image with Better Object Fit */}
        <img
        ...
        {/* Enhanced Content Overlay with Better Hierarchy */}
          ...
          <div className="max-w-7xl mx-auto h-full px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col justify-end h-full pb-6 sm:pb-8 md:pb-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8 items-end">
                {/* Left Content - Property Info (66% on desktop) */}
                <div className="lg:col-span-3 text-white space-y-4 sm:space-y-6">
                  {/* Enhanced Property Title with Better Typography & Shadow */}
                  <div className="space-y-4 sm:space-y-5">
                    ...
                    {/* Simplified Stats Row - Reduced Clutter */}
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-white/95">
                      <div className="flex items-center bg-white/25 backdrop-blur-sm px-3 py-1.5 rounded-full">
                  ...
                  {/* Simplified Trust Indicators - Less Cluttered */}
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-white/90">
                    <div className="flex items-center space-x-2 bg-green-500/40 backdrop-blur-sm px-3 py-1.5 rounded-full border border-green-400/50">
                      <Shield className="w-4 h-4 text-green-300" />
                      <span className="text-sm font-medium">Verified Host</span>
                    </div>
                    <div className="flex items-center space-x-2 bg-blue-500/40 backdrop-blur-sm px-3 py-1.5 rounded-full border border-blue-400/50">
                ...
                {/* Right Content - Compact CTA Card */}
                <div className="lg:col-span-2">
                  <div className="bg-white/15 backdrop-blur-xl rounded-2xl p-4 sm:p-5 border border-white/20 text-white shadow-2xl">
                    {/* Compact Quick Stats */}
                    <div className="grid grid-cols-3 gap-2 mb-3 sm:mb-4 text-center">
                      <div className="bg-white/15 backdrop-blur-sm rounded-xl p-2 border border-white/20 shadow-lg">
                        <div className="text-lg sm:text-xl font-bold text-white drop-shadow-sm">{property.guests}</div>
                        <div className="text-xs text-white/90 font-medium">Guests</div>
                      </div>
                      <div className="bg-white/15 backdrop-blur-sm rounded-xl p-2 border border-white/20 shadow-lg">
                        <div className="text-lg sm:text-xl font-bold text-white drop-shadow-sm">{property.bedrooms}</div>
                        <div className="text-xs text-white/90 font-medium">Bedrooms</div>
                      </div>
                      <div className="bg-white/15 backdrop-blur-sm rounded-xl p-2 border border-white/20 shadow-lg">
                        <div className="text-lg sm:text-xl font-bold text-white drop-shadow-sm">{property.bathrooms}</div>
                        <div className="text-xs text-white/90 font-medium">Bathrooms</div>
                      </div>
                    </div>

                    {/* Compact Urgency Indicator */}
                    <div className="bg-gradient-to-r from-amber-400/50 via-orange-400/50 to-red-400/50 border border-amber-300/60 rounded-xl p-2 mb-3 backdrop-blur-sm shadow-lg">
                      <div className="flex items-center justify-center space-x-1.5">
                        <div className="w-1.5 h-1.5 bg-amber-300 rounded-full animate-pulse"></div>
                        <Zap className="w-3 h-3 text-amber-200" />
                        <span className="text-xs font-semibold text-white">8 dates left</span>
                      </div>
                    </div>
                    ...
                    <button 
                      onClick={() => setIsBookingModalOpen(true)}
                      className="w-full bg-gradient-to-r from-rust-500 via-rust-600 to-rust-700 hover:from-rust-600 hover:via-rust-700 hover:to-rust-800 text-white font-bold py-2.5 sm:py-3 px-6 rounded-xl transition-all duration-300 text-sm sm:text-base shadow-xl hover:shadow-2xl transform hover:scale-105 active:scale-95 mb-2 border border-rust-400/30"
                    >
                      Book Now
                    </button>
                    ...
                    <button 
                      onClick={() => openLightbox(0)}
                      className="w-full bg-white/20 hover:bg-white/30 text-white py-2 px-4 rounded-xl transition-all duration-300 text-xs sm:text-sm backdrop-blur-sm border border-white/40 shadow-lg hover:shadow-xl"
                    >
                      View All Photos
                    </button>
                  </div>
        ...
        {/* Enhanced Image Navigation - Better Mobile UX */}
        ...
        {/* Enhanced Image Controls - Better Touch Targets */}
        <button
          onClick={prevImage}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12">
          ...
          <div className="lg:col-span-2 space-y-8 sm:space-y-12">
            ...
            <div className="bg-gradient-to-r from-rust-50 to-orange-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-rust-100">
              <h2 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">Why Choose This Property?</h2>
            ...
            {/* Quick Summary Cards - Psychological UX Enhancement */}
            ...
            {/* Property Stats */}
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-4 sm:space-y-0 sm:space-x-6 lg:space-x-8 text-gray-600 border-b border-gray-200 pb-6 sm:pb-6">
              <div className="flex items-center">
                <Users className="w-5 h-5 sm:w-5 sm:h-5 mr-3" />
                <span className="text-base sm:text-base font-medium">{property.guests} guests</span>
              </div>
              <div className="flex items-center">
                <Bed className="w-5 h-5 sm:w-5 sm:h-5 mr-3" />
                <span className="text-base sm:text-base font-medium">{property.bedrooms} bedrooms</span>
              </div>
              <div className="flex items-center">
                <Shield className="w-5 h-5 sm:w-5 sm:h-5 mr-3" />
                <span className="text-base sm:text-base font-medium">{property.bathrooms} bathrooms</span>
              </div>
            </div>
            ...
            {/* Unique Selling Point Banner - Psychological UX Enhancement */}
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-xl sm:rounded-2xl p-4 sm:p-6">
              <div className="flex items-start space-x-3">
                <div className="w-10 h-10 bg-amber-100 rounded-full flex items-center justify-center flex-shrink-0">
                  <Sparkles className="w-5 h-5 text-amber-600" />
                </div>
                <div>
                  <h3 className="text-lg font-medium text-gray-900 mb-1">Unique Heritage Experience</h3>
                  <p className="text-sm text-gray-700 mb-3">Only property in Bandra with original colonial stained glass windows and century-old teak woodwork. A truly one-of-a-kind stay that combines historical charm with modern luxury.</p>
                  <div className="flex items-center space-x-4 text-xs text-gray-600">
                    <span className="flex items-center">
                      <CheckCircle className="w-3 h-3 text-green-500 mr-1" />
                      Original 1923 architecture
                    </span>
                    <span className="flex items-center">
                      <CheckCircle className="w-3 h-3 text-green-500 mr-1" />
            ...
            {/* Perfect For Section - Psychological UX Enhancement */}
            <div className="bg-gradient-to-r from-sage-50 to-teal-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-sage-100">
              <h3 className="text-lg sm:text-xl font-medium text-gray-900 mb-4">Perfect For</h3>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                <div className="flex items-center space-x-3 p-3 bg-white/60 rounded-lg">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">Couples</div>
                    <div className="text-xs text-gray-600">Romantic getaways</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-white/60 rounded-lg">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-600">Spacious & safe</div>
                  </div>
                </div>
                <div className="flex items-center space-x-3 p-3 bg-white/60 rounded-lg">
                  ...
                  <div>
                    <div className="font-medium text-gray-900">Solo Travelers</div>
                    <div className="text-xs text-gray-600">Authentic experience</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Story */}
            <div className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-light text-gray-900 mb-4 sm:mb-6">The Story</h2>
              <p className="text-gray-700 leading-relaxed text-base sm:text-lg">
                {property.story}
              </p>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                {(() => {
                  // Safely extract amenities with fallback
                  ...
                  return amenities.map((amenity: string, index: number) => (
                    <div key={index} className="flex items-center space-x-3 p-4 sm:p-4 bg-gray-50 rounded-lg">
                      <div className="w-10 h-10 sm:w-10 sm:h-10 bg-rust-100 rounded-full flex items-center justify-center">
                        <Sparkles className="w-5 h-5 sm:w-5 sm:h-5 text-rust-600" />
                      </div>
                      <span className="text-gray-700 font-medium text-base sm:text-base">{amenity}</span>
                    </div>
                  ));
                })()}
              </div>
            ...
            <div>
              ...
              <div className="space-y-6 sm:space-y-8">
                {(() => {
                  // Safely extract testimonials with fallback
                  ...
                  return testimonials.map((review, index) => (
                    <div key={index} className="bg-gray-50 rounded-xl sm:rounded-2xl p-4 sm:p-6">
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        <div>
                          <h4 className="font-medium text-gray-900 text-base sm:text-lg">{review.name}</h4>
                          <p className="text-gray-600 text-sm">Verified Guest</p>
                        </div>
                        <div className="flex items-center">
            ...
            <div>
              ...
              <div className="bg-gradient-to-r from-sage-50 to-teal-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8">
                <h3 className="text-lg sm:text-xl font-medium text-gray-900 mb-3 sm:mb-4">{property.location}</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div>
            ...
            <div>
              ...
              <div className="bg-white border border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
                <h3 className="text-lg sm:text-xl font-medium text-gray-900 mb-4 sm:mb-6 flex items-center">
                  <MapPin className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 text-rust-600" />
                  How to Reach
                </h3>
              ...
              <div className="bg-white border border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
                <h3 className="text-lg sm:text-xl font-medium text-gray-900 mb-4 sm:mb-6 flex items-center">
                  <Star className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 text-rust-600" />
                  What's Around
                </h3>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
                  {/* Restaurants */}
              ...
              <div className="bg-white border border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8">
                <h3 className="text-lg sm:text-xl font-medium text-gray-900 mb-4 sm:mb-6 flex items-center">
                  <Shield className="w-5 h-5 sm:w-6 sm:h-6 mr-2 sm:mr-3 text-rust-600" />
              ...
              <div className="lg:col-span-1">
                <div className="lg:sticky lg:top-24">
                  {/* Booking Card */}
                  <div id="booking-card" className="bg-white border border-gray-200 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl">
                    {/* Enhanced Pricing Display */}
                    <div className="text-center mb-6 sm:mb-6">
                      <div className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">{formatPrice(property.price)}</div>
                      <div className="text-gray-600 text-base sm:text-lg font-medium">per night</div>
        ...
        {/* Property Story Gallery */}
        <div className="mt-8 sm:mt-16">
          <PropertyStoryGallery 
